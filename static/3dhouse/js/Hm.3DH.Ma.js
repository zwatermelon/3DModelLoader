...
var loaderStartTime; 
var miniModelPath = basicModelPath + "ma_01.js";  //马
var miniPicPath = basicPicPath + "ma_01.png";
var initMiniPic;
...
function loaderHouse(){
	...
	var callcackMini= function( geometry, materials  ) {
		...
		mini = new THREE.Mesh( geometry,new THREE.MeshBasicMaterial({map : initMiniPic}) ); 
		mini.position.set( 0,-50,0 ); 
		mini.scale.set( 1, 1, 1 );
		mini.rotation.set(0,-Math.PI/3 , 0);
