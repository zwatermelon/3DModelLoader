...
var loaderStartTime; 
var miniModelPath = basicModelPath + "g_model_01.js";  //马
var miniPicPath = basicPicPath + "xuezi.png";
var initMiniPic;
...
function initScene(){
	...
	//var directionalLight = new THREE.DirectionalLight( 0xffffff, 500);
...
function loaderHouse(){
	...
	var callcackMini= function( geometry, materials  ) {
		...
		mini = new THREE.Mesh( geometry, materials[0] ); 
		mini.position.set(0,0,0 ); 
		mini.scale.set( 50, 50, 50 );
